...
# myNetwork.add_person_relation_property(testPerson1, testPerson2, "friend", True)
# myNetwork.add_person_relation_property(testPerson2, testPerson3, "friend", False)
# myNetwork.add_person_relation_property(testPerson2, testPerson3, "friend", True)
# print(myNetwork.friends_of_friends("john"))
